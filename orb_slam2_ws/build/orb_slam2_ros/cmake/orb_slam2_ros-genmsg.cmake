...
get_filename_component(_filename "/ros_ws/orb_slam2_ws/src/orb_slam_2_ros/srv/SaveMap.srv" NAME_WE)
add_custom_target(_orb_slam2_ros_generate_messages_check_deps_${_filename}
  COMMAND ${CATKIN_ENV} ${PYTHON_EXECUTABLE} ${GENMSG_CHECK_DEPS_SCRIPT} "orb_slam2_ros" "/ros_ws/orb_slam2_ws/src/orb_slam_2_ros/srv/SaveMap.srv" ""
)
...
_generate_srv_cpp(orb_slam2_ros
  "/ros_ws/orb_slam2_ws/src/orb_slam_2_ros/srv/SaveMap.srv"
  "${MSG_I_FLAGS}"
  ""
...
if(genpy_INSTALL_DIR AND EXISTS ${CATKIN_DEVEL_PREFIX}/${genpy_INSTALL_DIR}/orb_slam2_ros)
  install(CODE "execute_process(COMMAND \"/usr/bin/python2\" -m compileall \"${CATKIN_DEVEL_PREFIX}/${genpy_INSTALL_DIR}/orb_slam2_ros\")")
  # install generated code
  install(
